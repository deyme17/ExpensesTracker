...
class AccountSelectPopup(ModalView):
    ...
    def _build_content(self):
        ...
        if not self.accounts:
            ...
            for acc in self.accounts:
                ...
                btn.bind(on_press=lambda btn: self._select_account(btn.text))
        ...
        save_btn.bind(on_press=self._save_selection)
    ...
    def _save_selection(self, *args):
        if self.selected_account and self.on_account_selected:
            self.on_account_selected(self.selected_account)
        self.dismiss()